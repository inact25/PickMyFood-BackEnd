...
import (
	...
	ratingControllers "github.com/inact25/PickMyFood-BackEnd/masters/apis/controllers/rating"
...
func Init(r *mux.Router, db *sql.DB) {
	...
	ratingController := ratingControllers.RatingController(ratingUseCase)
