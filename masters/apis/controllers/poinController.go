...
func PointsController(r *mux.Router, service usecases.PoinUseCases) {
	...
	r.HandleFunc("/product/{sid}", PointsHandler.GetPointByID).Methods(http.MethodGet)
	r.HandleFunc("/product", PointsHandler.PostPoint()).Methods(http.MethodPost)
	r.HandleFunc("/product/{sid}", PointsHandler.UpdatePoint()).Methods(http.MethodPut)
	r.HandleFunc("/product/{sid}", PointsHandler.DeletePoint()).Methods(http.MethodDelete)
